...
|
*/
$config['base_url'] = 'http://localhost/newsletter/';
...
$config['sess_save_path'] = APPPATH.'/sess_data/';
...
$config['csrf_token_name'] = 'csrf_btc';
$config['csrf_cookie_name'] = 'csrf_btc_cke';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
//api calls exclude from csrf
